...
'''
It is good to see that you write different functions in different modules. You separate the x and y and compute them respectively which is unnecessary. You can calculate them together. It would be better if you add comment to the code next time. 
'''